...
// Gated sections stay out of the nav until their flag is on.
const navLinks = allNavLinks.filter((link) => {
  if (link.href === "/floor") return FEATURES.floor;
  if (link.href === "/launch") return FEATURES.launch;
  if (link.href === "/bounty") return FEATURES.bounty;
  return true;
});
      ...
      {mobileOpen && (
        <div className="md:hidden bg-bg/95 backdrop-blur-md border-b border-border">
          <nav className="max-w-5xl mx-auto px-6 py-4 flex flex-col gap-4">
            ...
            {/* Socials — desktop keeps these in the top bar, mobile needs them here. */}
