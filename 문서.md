...
**배포 상태:** Devnet 배포 완료 (Slot #444885065, 2.15 SOL 사용)
...
1. **Vercel 환경변수 전환:** FEATURE_TRADING=true, FEATURE_REFUND=true로 변경 후 재배포
2. **텔레그램 봇 테스트:** 알림 수신 확인
3. **트위터/텔레그램 채널 개설:** 마케팅 카피는 준비 완료 (`산출물/마케팅/`)
